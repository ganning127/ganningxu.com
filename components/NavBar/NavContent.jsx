...
const MobileNavContent = (props) => {
    ...
    return (
        <Box {...props}>
            <Icon as={icon} color={textColors[colorMode]} fontSize="lg" alignSelf="center" mr="8" _hover={{ color: 'blue.light', cursor: 'pointer' }} onClick={toggleColorMode} />
            <Center
                as="button"
                p="2"
                ...
                color="white"
            >
                {isOpen ? <HiX color={textColors[colorMode]} /> : <HiOutlineMenu color={textColors[colorMode]} />}
            </Center>
...
const DesktopNavContent = (props) => {
    ...
    return (
        <HStack spacing="8" align="stretch" {...props}>
            ...
            <NavLink.Desktop fontSize="2xl" fontWeight="bold" _hover={{ color: 'blue.light', cursor: 'pointer' }} onClick={toggleColorMode}>
