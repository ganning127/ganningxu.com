...
export function IntroSection() {
  ...
  return (
    <>
      ...
      {/* Wrap the transitioning content with AnimatePresence */}
      <AnimatePresence mode="wait">
        {showLonger ? (
          <motion.section
            key="long-version" // Add a unique key
          ...
          >
            <p>
              ...
              of new cases daily in North Carolina (where I live), and in the
              USA. Building this tool taught me my true passion:{" "}
              ...
              <br />
              <br />
              Then, I wanted to build dynamic web applications. After applying
              to hundreds of internships, and needing to customize my resume for
              each one, I built{" "}
              <Link href="https://github.com/kambhani/aire">
                an AI tool that customizes your resume (with your own
                experiences) for each job application
              </Link>
              . Around this time, I also realized there were not many study
              timer Chrome extensions. So I built one myself:{" "}
              ...
              . Additionally, upperclassmen often have advice on specific
              classes they can share with new students, so I built a{" "}
              ...
              make people&apos;s lives easier. If you have any ideas or would
              like to chat, please don&apos;t hesitate to{" "}
              <Link href="mailto:ganning.xu@gatech.edu">reach out!</Link>
            </p>
          </motion.section>
        ) : (
          <motion.div
            key="short-version" // Add a unique key
            variants={animationVariants}
            initial="initial"
            animate="animate"
            exit="exit"
